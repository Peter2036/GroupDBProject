...
public class directorListWriters extends HttpServlet{
     @Override
    public void doGet(
        ...
        try {
            listWriters(type, out, id);
        } catch (SQLException ex) {
            Logger.getLogger(percentDistribution.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    
    private void listWriters(String type, PrintWriter out, String id) throws SQLException{
       ...
       String query = "select d.director_ID as T1, b.name as Writers "
