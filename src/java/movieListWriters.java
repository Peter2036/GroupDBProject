...
public class movieListWriters extends HttpServlet{
    @Override
    public void doGet(
    ...
    private void listWriters(PrintWriter out, String id) throws SQLException{
        ...
        try {
            ...
            String query = "select a.movie_ID, b.name as Writers "
