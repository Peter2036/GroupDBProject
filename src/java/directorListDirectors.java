...
public class directorListDirectors extends HttpServlet {
    @Override
    public void doGet(
        ...
        try {
            listDirectors(type, out, id);
        } catch (SQLException ex) {
            Logger.getLogger(percentDistribution.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    
    private void listDirectors(String type, PrintWriter out, String id) throws SQLException{
       ...
       String query = "select d1.director_ID as T1, b.name as Directors "
